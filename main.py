...
from modules.eye_identifier import identify_eye_snapshot
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        ...
        if not eye_image_saved:
            ...
            temp_path = "snapshots/temp_eye.jpg"
            cv2.imwrite(temp_path, eye_crop)
            ...
            final_path = f"snapshots/{name}_{today}.jpg"
